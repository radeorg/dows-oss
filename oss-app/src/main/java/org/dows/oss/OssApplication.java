...
public class OssApplication implements AppInstance {
    ...
    public static void main(String[] args) {
        ...
        context = SpringApplication.run(OssApplication.class, args);
    }


    public Class<?> getAppClass() {
        return OssApplication.class;
    }
...
//                    log.error("loadClassErr {}", javaPath, e);
            ...
            context = SpringApplication.run(OssApplication.class, args.getSourceArgs());
        });
        // 设置线程的上下文类加载器
